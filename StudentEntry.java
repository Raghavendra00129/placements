...
public class StudentEntry extends javax.swing.JFrame {
    ...
    public StudentEntry() {
        initComponents();
        getContentPane().setBackground(new java.awt.Color(213,125,63));
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("DAYANANDA SAGAR COLLEGE OF ENGINEERING");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("SKILL");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("SKILL2");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel8.setText("SKILL3");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String status = "NO", company = "NULL",company2 = "NULL",company3 = "NULL";
        String skill = jTextField4.getText();
        String skill2 = jTextField5.getText();
        String skill3 = jTextField6.getText();
        String mobile = jTextField7.getText();
        String email = jTextField8.getText();   
        float salary = 0,salary2 = 0,salary3 = 0;
        try
        {
            Class.forName("java.sql.DriverManager");
            Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","1DS16CS090");
            Statement stmt = (Statement)con.createStatement();
            String query = "INSERT INTO placements VALUES('"+usn+"','"+name+"','"+branch+"','"+status+"','"+company+"',"+salary+",'"+email+"','"+skill+"','"+skill2+"','"+skill3+"','"+mobile+"','"+company2+"','"+company3+"',"+salary2+","+salary3+");";
